...
def send_project_enquiry_email(enquiry: dict):
    subject = f"Project Enquiry (Chatbot) from {enquiry.get('name','Unknown')}"
    ...
    <div style="max-width:650px; margin:auto; background:#fff; border-radius:8px; overflow:hidden; box-shadow:0 2px 6px rgba(0,0,0,0.1);">
        ...
        <img src="https://terralogic.com/wp-content/uploads/2025/09/terralogic-logo.png" 
            alt="Terralogic Logo" width="20%" height="auto">
        ...
        This is an automated notification from <b>Terralogic</b>.<br>
        </div>
    </div>
    </body>
    </html>
